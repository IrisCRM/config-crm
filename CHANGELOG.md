...
### Основные изменения
*  Исправлена добавление таблицы с провами доступа при создании новой таблицы
*  Исправлено отображение чекбокса на вкладке "История изменений" (@uokersam)
*  Исправлена очистка галочки "Напомнить" при изменении времени напоминания 

<a name="5.7.2"></a>
# 5.7.2 (2019-02-18)

### Основные изменения
*  Исправлено считывание файлов при импорте
...
### Основные изменения
*  Оптимизировано отображение писем в разделе "Почта"
*  Оптимизация кода, исправление ошибок
...
*  Исправлен формат дат в рабочем календаре
